...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"busIcon\": function() { return /* binding */ busIcon; },\n/* harmony export */   \"busIcon2x\": function() { return /* binding */ busIcon2x; }\n/* harmony export */ });\n/* harmony import */ var leaflet__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! leaflet */ \"leaflet\");\n/* harmony import */ var leaflet__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(leaflet__WEBPACK_IMPORTED_MODULE_0__);\n\nvar busIcon = null;\nvar busIcon2x = null;\n\nif (typeof process != \"undefined\" && process.env.IGNORE_IMAGES) {\n  console.log(\"using fake images\");\n} else {\n  console.log(\"using real images\");\n\n  var busIconImage = __webpack_require__(/*! ../images/bus.png */ \"./src/images/bus.png\");\n\n  var busIconShadow = __webpack_require__(/*! ../images/animated-circle.gif */ \"./src/images/animated-circle.gif\");\n\n  var busIconImage2x = __webpack_require__(/*! ../images/bus-2x.png */ \"./src/images/bus-2x.png\");\n\n  var BusIcon = leaflet__WEBPACK_IMPORTED_MODULE_0___default().Icon.extend({\n    options: {\n      iconSize: [40, 40],\n      iconAnchor: [20, 20],\n      popupAnchor: [0, -45],\n      shadowSize: [40, 40],\n      shadowAnchor: [20, 20]\n    }\n  });\n  var BusIcon2x = leaflet__WEBPACK_IMPORTED_MODULE_0___default().Icon.extend({\n    options: {\n      iconSize: [82, 82],\n      iconAnchor: [41, 41],\n      popupAnchor: [0, -45]\n    }\n  });\n  busIcon = new BusIcon({\n    iconUrl: busIconImage,\n    shadowUrl: busIconShadow\n  });\n  busIcon2x = new BusIcon2x({\n    iconUrl: busIconImage2x\n  });\n}\n\n//# sourceURL=webpack://btrzMap/./src/icons/bus-icons.js?");

/***/ }),

/***/ "./src/icons/station-icons.js":
/*!************************************!*\
  !*** ./src/icons/station-icons.js ***!
  \************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"stationIcon\": function() { return /* binding */ stationIcon; },\n/* harmony export */   \"firstStationIcon\": function() { return /* binding */ firstStationIcon; },\n/* harmony export */   \"lastStationIcon\": function() { return /* binding */ lastStationIcon; },\n/* harmony export */   \"stationIcon2x\": function() { return /* binding */ stationIcon2x; },\n/* harmony export */   \"firstStationIcon2x\": function() { return /* binding */ firstStationIcon2x; },\n/* harmony export */   \"lastStationIcon2x\": function() { return /* binding */ lastStationIcon2x; }\n/* harmony export */ });\n/* harmony import */ var leaflet__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! leaflet */ \"leaflet\");\n/* harmony import */ var leaflet__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(leaflet__WEBPACK_IMPORTED_MODULE_0__);\n\nvar stationIcon = null;\nvar firstStationIcon = null;\nvar lastStationIcon = null;\nvar stationIcon2x = null;\nvar firstStationIcon2x = null;\nvar lastStationIcon2x = null;\n\nif (typeof process != \"undefined\" && process.env.IGNORE_IMAGES) {\n  console.log(\"using fake images\");\n} else {\n  console.log(\"using real images\");\n\n  var origin = __webpack_require__(/*! ../images/circle-origin.png */ \"./src/images/circle-origin.png\");\n\n  var origin2x = __webpack_require__(/*! ../images/circle-origin.png */ \"./src/images/circle-origin.png\"); //TODO: missing 2x image\n\n\n  var station = __webpack_require__(/*! ../images/circle-station.png */ \"./src/images/circle-station.png\");\n\n  var station2x = __webpack_require__(/*! ../images/circle-station.png */ \"./src/images/circle-station.png\"); //TODO: missing 2x image\n\n\n  var destination = __webpack_require__(/*! ../images/circle-destination.png */ \"./src/images/circle-destination.png\");\n\n  var destination2x = __webpack_require__(/*! ../images/circle-destination.png */ \"./src/images/circle-destination.png\"); //TODO: missing 2x image\n\n\n  var StationIcon = leaflet__WEBPACK_IMPORTED_MODULE_0___default().Icon.extend({\n    options: {\n      iconSize: [20, 20],\n      iconAnchor: [10, 10],\n      popupAnchor: [0, -25]\n    }\n  });\n  var StationIcon2X = leaflet__WEBPACK_IMPORTED_MODULE_0___default().Icon.extend({\n    options: {\n      iconSize: [66, 93],\n      iconAnchor: [33, 90],\n      popupAnchor: [0, -35]\n    }\n  });\n  stationIcon = new StationIcon({\n    iconUrl: station\n  });\n  firstStationIcon = new StationIcon({\n    iconUrl: origin\n  });\n  lastStationIcon = new StationIcon({\n    iconUrl: destination\n  });\n  stationIcon2x = new StationIcon2X({\n    iconUrl: station2x\n  });\n  firstStationIcon2x = new StationIcon2X({\n    iconUrl: origin2x\n  });\n  lastStationIcon2x = new StationIcon2X({\n    iconUrl: destination2x\n  });\n}\n\n//# sourceURL=webpack://btrzMap/./src/icons/station-icons.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"MarkerProvider\": function() { return /* binding */ MarkerProvider; }\n/* harmony export */ });\n/* harmony import */ var leaflet__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! leaflet */ \"leaflet\");\n/* harmony import */ var leaflet__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(leaflet__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _icons_bus_icons__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../icons/bus-icons */ \"./src/icons/bus-icons.js\");\n/* harmony import */ var _icons_station_icons__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../icons/station-icons */ \"./src/icons/station-icons.js\");\n/* harmony import */ var _utils_utils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utils/utils */ \"./src/utils/utils.js\");\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, \"prototype\", { writable: false }); return Constructor; }\n\n\n\n\n\n/** This class should be the only one which depends on leaflet **/\n\nvar MarkerProvider = /*#__PURE__*/function () {\n  function MarkerProvider() {\n    _classCallCheck(this, MarkerProvider);\n  }\n\n  _createClass(MarkerProvider, [{\n    key: \"getBusMarker\",\n    value: function getBusMarker(_ref) {\n      var position = _ref.position;\n\n      try {\n        (0,_utils_utils__WEBPACK_IMPORTED_MODULE_3__.validateCoordinates)({\n          latitude: position.latitude,\n          longitude: position.longitude\n        });\n        return leaflet__WEBPACK_IMPORTED_MODULE_0___default().marker([position.latitude, position.longitude], {\n          icon: _icons_bus_icons__WEBPACK_IMPORTED_MODULE_1__.busIcon\n        });\n      } catch (error) {\n        console.log(\"can't get a marker for bus: \", error);\n        return null;\n      }\n    }\n  }, {\n    key: \"getStationIcon\",\n    value: function getStationIcon(_ref2) {\n      var position = _ref2.position,\n          isLastStation = _ref2.isLastStation,\n          isFirstStation = _ref2.isFirstStation;\n      var icon;\n\n      if (isLastStation) {\n        icon = _icons_station_icons__WEBPACK_IMPORTED_MODULE_2__.lastStationIcon;\n      } else if (isFirstStation) {\n        icon = _icons_station_icons__WEBPACK_IMPORTED_MODULE_2__.firstStationIcon;\n      } else {\n        icon = _icons_station_icons__WEBPACK_IMPORTED_MODULE_2__.stationIcon;\n      }\n\n      try {\n        (0,_utils_utils__WEBPACK_IMPORTED_MODULE_3__.validateCoordinates)({\n          latitude: position.latitude,\n          longitude: position.longitude\n        });\n        return leaflet__WEBPACK_IMPORTED_MODULE_0___default().marker([position.latitude, position.longitude], {\n          icon: icon\n        });\n      } catch (error) {\n        console.log(\"can't get a marker for station: \", error);\n        return null;\n      }\n    }\n  }, {\n    key: \"getTravelPathPolyline\",\n    value: function getTravelPathPolyline(_ref3) {\n      var latLongs = _ref3.latLongs,\n          travelledPathRenderOptions = _ref3.travelledPathRenderOptions;\n      return leaflet__WEBPACK_IMPORTED_MODULE_0___default().polyline(latLongs, travelledPathRenderOptions);\n    }\n  }, {\n    key: \"getCenterControl\",\n    value: function getCenterControl() {\n      return leaflet__WEBPACK_IMPORTED_MODULE_0___default().control.centerButton({\n        position: \"topleft\"\n      });\n    }\n  }]);\n\n  return MarkerProvider;\n}();\n\n//# sourceURL=webpack://btrzMap/./src/markers/MarkerProvider.js?");
